<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="文档" prop="wendang">
          <file-upload
          tip="点击上传文档"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wendang" label="文档" prop="wendang">
            <el-button type="text" size="small" @click="download(ruleForm.wendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="涉及领域" prop="shejilingyu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="涉及领域"
                  v-model="ruleForm.shejilingyu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shejilingyu" label="涉及领域" prop="shejilingyu">
                    <span>{{ruleForm.shejilingyu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmumiaoshu = true;
          ...
          if(o=='shejilingyu'){
            this.ruleForm.shejilingyu = obj[o];
	    this.ro.shejilingyu = true;
            continue;
          }
          if(o=='wendang'){
