<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学生负责人" prop="xueshengfuzeren">
          <el-input v-model="ruleForm.xueshengfuzeren" 
              placeholder="学生负责人" clearable  :readonly="ro.xueshengfuzeren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学生负责人" prop="xueshengfuzeren">
              <el-input v-model="ruleForm.xueshengfuzeren" 
                placeholder="学生负责人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="指导老师" prop="zhidaolaoshi">
          <el-input v-model="ruleForm.zhidaolaoshi" 
              placeholder="指导老师" clearable  :readonly="ro.zhidaolaoshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="指导老师" prop="zhidaolaoshi">
              <el-input v-model="ruleForm.zhidaolaoshi" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="评审意见" prop="pingshenyijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="评审意见"
                  v-model="ruleForm.pingshenyijian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pingshenyijian" label="评审意见" prop="pingshenyijian">
                    <span>{{ruleForm.pingshenyijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xueshengfuzeren : false,
	zhidaolaoshi : false,
	pingshenyijian : false,
	tupian : false,
      },
      ruleForm: {
        xiangmumingcheng: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmujianjie = true;
          ...
          if(o=='xueshengfuzeren'){
            this.ruleForm.xueshengfuzeren = obj[o];
	    this.ro.xueshengfuzeren = true;
            continue;
          }
          if(o=='zhidaolaoshi'){
	    ...
	    this.ro.zhidaolaoshi = true;
          ...
          if(o=='pingshenyijian'){
            this.ruleForm.pingshenyijian = obj[o];
	    this.ro.pingshenyijian = true;
            continue;
          }
          if(o=='tupian'){
